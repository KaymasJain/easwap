...
function addOrderbookContract(add) {
	reserveLister.addOrderbookContract(add, (err, res) => {
		if (err) {
			console.log(err);
		} else {
			console.log(res)
...
function initOrderbookContract(add) {
	reserveLister.initOrderbookContract(add, (err, res) => {
		if (err) {
			console.log(err);
		} else {
			console.log(res)
...
function listOrderbookContract(add) {
	reserveLister.listOrderbookContract(add, (err, res) => {
		if (err) {
			console.log(err);
		} else {
			console.log(res)
...
function createOrderBook(cmcName) {
	...
	if (coinDetails) {
		reserveLister.addOrderbookContract(coinDetails.contractAddress, (err, res) => {
            if (err) {
                console.log(err);
            } else {
                var payObj = {
                ...
                reserveLister.initOrderbookContract(coinDetails.contractAddress, payObj, (err, res) => {
                    if (err) {
                        console.log(err);
                    } else {
